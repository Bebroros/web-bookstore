...
| POST | /books | Add new book | 201 | json {"name": "Dune", "description": "...", "genre": Science-fiction, "author_id": 1, "price": 15.00, "year": 2020} | json {"id": 1, "name": "Dune", "description": "...", "genre": Science-fiction, "author": "Frank Herbert", "price": 15.00, "popularity": 100, "year": 2020} |
| PUT | /books/{id} | Update a book | 200, 404(if not found) | json {"price: 10.00"} | json {"id": 1, "name": "Dune", "description": "...", "genre": Science-fiction, "author": "Frank Herbert", "price": 10.00, "popularity": 100}, "year": 2020 |
...
| GET | /authors/{id} | Get an author by id | 200 | - | json {"id": 1, "name": "Frank Herbert", "description": "...", "books": [...]} |
| POST | /authors/{id} | Add a new author | 200 | json {"name": "Frank Herbert", "description": "...", "books": [...]} | json {"id": 1, "name": "Frank Herbert", "description": "...", "books": [...]} |
| PUT | /authors/{id} | Update an author | 200 | json {"description": "..."} | json {"id": 1, "name": "Frank Herbert", "description": "...", "books": [...]} |
| DELETE | /authors/{id} | Update an author | 204, 404(if not found)  | - | - |
...
| POST | /publishers | Add a new publisher | 201 | json {"name": "KCD", "books": [...], "description": "..."} | json {"id": 1, "name": "KCD", "books": [...], "description": "..."} |
| PUT | /publishers/{id} | Update a publisher | 200 | json {"description": "..."} | json {"id": 1, "name": "KCD", "books": [...], "description": "..."} |
...
<img width="918" height="790" alt="image" src="https://github.com/user-attachments/assets/52291639-bb82-4b04-9ccf-3a96023ae52e" />
